...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => [
                ...
                'description' => 'REST API for Task Management Platform with JWT Authentication. This API provides endpoints for managing tasks, comments, and file attachments.',
                'version' => '1.0.0',
            ],
            'routes' => [
    ...
    'defaults' => [
        ...
        'operations_sort' => env('L5_SWAGGER_OPERATIONS_SORT', 'path'),
        'validator_url' => null,
        'ui' => [
            'display' => [
